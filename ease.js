...
//------------------------------------------------------------------------------------------
function timer(Start_time,Easeing_time){
    var count = t-Start_time;
    if(count < 0){
        count = 0;
        return 0;
    }else if(count <= Easeing_time){
        return count/Easeing_time;
    }else if(count > Easeing_time){
        return 1;
    }
}
...
function ease(Easeing,Start_time,Easeing_time){
    ...
    if(count < 0){
        ...
        if(Easeing =="easeInOutElastic")    return easeInOutElastic(count/Easeing_time);
        else if(Easeing == "easeInOutExpo") return easeInOutExpo(count/Easeing_time);
        else if(Easeing == "easeInExpo")    return easeInExpo(count/Easeing_time);
        else if(Easeing == "easeOutExpo")   return easeOutExpo(count/Easeing_time);
